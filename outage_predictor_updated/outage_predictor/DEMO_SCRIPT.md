...
One thing Voltix deliberately doesn't do yet: predict outages by time of
day. The Band data tells you how many hours of power a street is
guaranteed per day — it doesn't say which hours, because DisCos don't
publish that schedule publicly. Rather than guess, we've left it out and
named it as the clear next step once that data becomes available."
